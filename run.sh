...
python3 pytorch-CycleGAN-and-pix2pix/train.py --dataroot "data" --name knees --model cycle_gan --batch_size 64 --n_epochs 100 --n_epochs_decay 100 --save_epoch_freq 10 --use_wandb --display_id -1 --no_html --gpu_ids 0 --input_nc 1 --output_nc 1
